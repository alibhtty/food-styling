...
let DIRECCIONES = {
  ...
  let FPS = 1000 / 10;  /* 1000 / 15 DEFAULT     Personal: 500 / 10;*/
  ...
  let SONIDO_GANASTE_PUNTO = new Audio("snake.mp3");  /* SOUND ON  ("ganaste_un_punto.wav") */
  ...
  function rellenarCuadrado(context, posX, posY) {
    context.beginPath();
    context.fillStyle = "#a93800"; /*COLOR SNAKE 2e490b*/
  ...
  function dibujarTexto(context, texto, x, y) {
    context.font = "30px Roboto"; /* TEXTO PANTALLA*/
  ...
  function mostrarPuntos(puntos) {
    PUNTOS_TEXTO.innerText = "SCORE : " + puntos;
  }
  ...
  function gameOver() {
    clearInterval(ciclo);
    ciclo = undefined;
    dibujarTexto(CTX, "¡GAME OVER!", 300, 250);
    dibujarTexto(CTX, "Jugar otra vez?", 300, 320);
  ...
  dibujarParedes(CTX);
  dibujarTexto(CTX, "¡START!", 300, 230,);
  dibujarTexto(CTX, "Ordenador: Muévete con ↑ ↓ → ←", 300, 320);
  dibujarTexto(CTX, "Móbil: Un tap para girar.", 300, 370);
